package com.example.yrx217.http;

import android.util.Log;


import com.example.yrx217.Common.Constants;
import com.example.yrx217.http.entity.HttpResult;
import com.example.yrx217.http.service.CategoryService;
import com.example.yrx217.http.service.GoodService;
import com.example.yrx217.http.service.MemberService;
...
public class HttpMethods {
    ...
    protected static GoodService goodsService;
    ...
    public HttpMethods(){
        if(sInstance ==null){
            ...
            goodsService = retrofit.create(GoodService.class);
